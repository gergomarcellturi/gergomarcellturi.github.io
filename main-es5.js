...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      path: '**',
      redirectTo: "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].defaultLanguage, "/calculator"),
      pathMatch: 'full'
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _calculator_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./calculator/sidebar/sidebar.component */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"].forRoot({
      ...
      }), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["RouterModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_13__["MatMenuModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _calculator_calculator_component__WEBPACK_IMPORTED_MODULE_3__["CalculatorComponent"], _calculator_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_10__["SidebarComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["RouterModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_13__["MatMenuModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppCalculatorCalculatorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var mathjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! mathjs */
    ...
    var _services_cache_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var CalculatorComponent = /*#__PURE__*/function () {
      function CalculatorComponent(translateService, elementRef, cacheService, eventService) {
      ...
      _createClass(CalculatorComponent, [{
        ...
        value: function cursorEffect() {
          var border = this.elementRef.nativeElement.ownerDocument.querySelector('.highlight');
          this.elementRef.nativeElement.ownerDocument.querySelector('.calculator-container').addEventListener('mousemove', function (ev) {
            var x = ev.pageX;
            var y = ev.pageY;
            var bounding = border.getBoundingClientRect();
            border.style.webkitMaskPosition = "".concat(x - bounding.x - 160, "px ").concat(y - bounding.y - 160, "px");
          });
        }
      }, {
        key: "toggleMenu",
        ...
        key: "input",
        value: function input(_char) {
          this.inputString += this.isOperator(_char) && this.isOperator(this.inputString[this.inputString.length - 1]) ? '' : _char;
        }
      }, {
        ...
        value: function deleteChar() {
          ...
          if ((this.isOperator(this.inputString[this.inputString.length - 1]) || this.inputString[this.inputString.length - 1] === ' ') && this.inputString.length !== 0) {
            this.deleteChar();
          }
        }
      }, {
        key: "getHistoryFromCache",
        value: function getHistoryFromCache() {
          var _this = this;

          this.cacheService.getCalcHistory.forEach(function (value) {
            return _this.calcHistory = [].concat(_toConsumableArray(_this.calcHistory), [{
              expression: value,
              value: mathjs__WEBPACK_IMPORTED_MODULE_2__["parse"](value).evaluate()
            }]);
          });
        }
      }, {
        ...
        key: "isOperator",
        value: function isOperator(_char2) {
          return _char2 === '/' || _char2 === '*' || _char2 === '+' || _char2 === '-' || _char2 === undefined;
        }
      }, {
        key: "corrigateInput",
        value: function corrigateInput() {
          this.inputString = this.inputString.replace(/\s/g, '');
          this.inputString = this.inputString.replace(this.getSearchExpression(), function (operator) {
            return " ".concat(operator, " ");
          });
        }
      }, {
        key: "getSearchExpression",
        value: function getSearchExpression() {
          return /[+/*-]/gi;
        }
      }, {
        key: "addToCalcHistory",
        value: function addToCalcHistory(resultString) {
          this.calcHistory = [{
            expression: resultString,
            value: mathjs__WEBPACK_IMPORTED_MODULE_2__["parse"](resultString).evaluate()
          }].concat(_toConsumableArray(this.calcHistory));
        }
      }, {
    ...
    CalculatorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CalculatorComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_input_click_18_listener() {
            return ctx.deleteChar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_40_listener() {
            return ctx.input("7");
          })("keyup.7", function CalculatorComponent_Template_div_keyup_7_40_listener() {
            return ctx.input("7");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_43_listener() {
            return ctx.input("8");
          })("keyup.8", function CalculatorComponent_Template_div_keyup_8_43_listener() {
            return ctx.input("8");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_46_listener() {
            return ctx.input("9");
          })("keyup.9", function CalculatorComponent_Template_div_keyup_9_46_listener() {
            return ctx.input("9");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_49_listener() {
            return ctx.input("/");
          })("keyup.escape", function CalculatorComponent_Template_div_keyup_escape_49_listener() {
            return ctx.input("/");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_52_listener() {
            return ctx.input("4");
          })("keyup.4", function CalculatorComponent_Template_div_keyup_4_52_listener() {
            return ctx.input("4");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_55_listener() {
            return ctx.input("5");
          })("keyup.5", function CalculatorComponent_Template_div_keyup_5_55_listener() {
            return ctx.input("5");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_58_listener() {
            return ctx.input("6");
          })("keyup.6", function CalculatorComponent_Template_div_keyup_6_58_listener() {
            return ctx.input("6");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_61_listener() {
            return ctx.input("*");
          })("keyup.*", function CalculatorComponent_Template_div_keyup___61_listener() {
            return ctx.input("*");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_64_listener() {
            return ctx.input("1");
          })("keyup.1", function CalculatorComponent_Template_div_keyup_1_64_listener() {
            return ctx.input("1");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_67_listener() {
            return ctx.input("2");
          })("keyup.2", function CalculatorComponent_Template_div_keyup_2_67_listener() {
            return ctx.input("2");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_70_listener() {
            return ctx.input("3");
          })("keyup.3", function CalculatorComponent_Template_div_keyup_3_70_listener() {
            return ctx.input("3");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_73_listener() {
            return ctx.input("-");
          })("keyup.-", function CalculatorComponent_Template_div_keyup___73_listener() {
            return ctx.input("-");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_76_listener() {
            return ctx.evaluateExpression();
          })("keyup.enter", function CalculatorComponent_Template_div_keyup_enter_76_listener() {
            return ctx.evaluateExpression();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_79_listener() {
            return ctx.input("0");
          })("keyup.0", function CalculatorComponent_Template_div_keyup_0_79_listener() {
            return ctx.input("0");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_82_listener() {
            return ctx.input("+");
          })("keyup.+", function CalculatorComponent_Template_div_keyup___82_listener() {
            return ctx.input("+");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CalculatorComponent_Template_div_click_85_listener() {
            return ctx.clearInput();
          })("keyup.backspace", function CalculatorComponent_Template_div_keyup_backspace_85_listener() {
            return ctx.clearInput();
          });
      ...
      data: {
        animation: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('slideInOut', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('in', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({
        ...
        })), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('in => out', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('400ms ease-in-out')), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('out => in', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('400ms ease-in-out'))])]
      }
    });
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CalculatorComponent, [{
        ...
        args: [{
          ...
          animations: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('slideInOut', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('in', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({
            transform: 'translate3d(0,0,0)'
          })), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('out', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({
            transform: 'translate3d(100%, 0, 0)'
          })), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('in => out', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('400ms ease-in-out')), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('out => in', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('400ms ease-in-out'))])]
        ...
        return [{
          ...
          type: _services_cache_service__WEBPACK_IMPORTED_MODULE_4__["CacheService"]
        }, {
  ...
  /***/
  function srcAppCalculatorSidebarSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function SidebarComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidebarComponent_div_1_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);

          var history_r1 = ctx.$implicit;

          var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r2.clickEventHandler(history_r1);
        });
    ...
    var SidebarComponent = /*#__PURE__*/function () {
      function SidebarComponent(eventService) {
      ...
      _createClass(SidebarComponent, [{
        ...
        value: function clickEventHandler(history) {
    ...
    SidebarComponent.ɵfac = function SidebarComponent_Factory(t) {
      return new (t || SidebarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_event_service__WEBPACK_IMPORTED_MODULE_1__["EventService"]));
    };
    ...
    SidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "card-list"], ["class", "card-container", 3, "click", 4, "ngFor", "ngForOf"], [1, "card-container", 3, "click"], [1, "card"], [1, "card-header"], [1, "card-body"]],
  ...
  /***/
  function srcAppServicesCacheServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CacheService = /*#__PURE__*/function () {
      function CacheService() {
        ...
        this.calcHistorySubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](JSON.parse(localStorage.getItem('calcHistory')) && JSON.parse(localStorage.getItem('calcHistory')).slice(0, 9) || []);
        this.calcHistory = this.calcHistorySubject.asObservable();
      }

      _createClass(CacheService, [{
        key: "addCalcHistory",
        value: function addCalcHistory(calcHistory) {
          var calcHistoryArray = [].concat(_toConsumableArray(this.getCalcHistory), [calcHistory]);
        ...
        key: "clearCalcHistory",
        value: function clearCalcHistory() {
          localStorage.clear();
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Development\university\szfm_calculator\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
